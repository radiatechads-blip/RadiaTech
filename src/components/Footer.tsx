    ...
    <footer className="bg-primary text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10">
            ...
            <div className="flex items-center gap-3">
              {["facebook", "instagram", "indiamart"].map((s) => (
                <a
                  key={s}
                  href={
                    companyInfo.social[s as keyof typeof companyInfo.social]
                  }
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-accent transition-all hover:scale-105"
                  aria-label={s}
                >
                  {s === "facebook" ? (
                    /* Facebook SVG */
                    ...
                    /* IndiaMART fallback */
                    <span className="text-[10px] font-bold uppercase">IM</span>
                  )}
                </a>
              ))}
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-5">
              Quick Links
            </h3>
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-blue-100 hover:text-accent transition-colors text-xs sm:text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-blue-100 hover:text-accent transition-colors text-xs sm:text-sm"
                >
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-blue-100 hover:text-accent transition-colors text-xs sm:text-sm break-all"
                >
