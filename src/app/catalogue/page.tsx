      ...
      <section className="bg-primary py-18">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="/RADIATECH-CATALOGUE.pdf" target="_blank" rel="noopener noreferrer" className="bg-accent hover:bg-accent-dark px-8 py-4 font-bold text-sm text-white transition-all flex items-center gap-2 rounded-2xl">
